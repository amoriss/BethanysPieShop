    ...
    public class MockPieRepository : IPieRepository
    {
        ...
        public IEnumerable<Pie> AllPies =>
            new List<Pie>
            {
                ...
                new Pie {PieId = 3, Name="Rhubarb Pie", Price=15.95M, ShortDescription = "Lorem ", LongDescription = "Lorem", Category = _categoryRepository.AllCategories.ToList()[0]},
                new Pie {PieId = 4, Name="Pumpkin Pie", Price=12.95M, ShortDescription = "Lorem ", LongDescription = "Lorem", Category = _categoryRepository.AllCategories.ToList()[2]}
